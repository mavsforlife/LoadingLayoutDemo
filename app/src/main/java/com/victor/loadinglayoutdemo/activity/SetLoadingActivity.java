...
public class SetLoadingActivity extends AppCompatActivity implements View.OnClickListener{

    LoadingLayout loadingLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_set_loading);

        initView();
    }

    private void initView() {
        setTitle(R.string.set_loading_activity);
    ...
    public static void enter(Context context) {
        context.startActivity(new Intent(context, SetLoadingActivity.class));
    }
